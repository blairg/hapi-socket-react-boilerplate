...
describe('shared/helpers/formatTime', () => {
  ...
  it('should return "1 week ago" when the date is 7 days in the past', () => {
    const todoDate = 100;
  ...
  it('should return "1 month ago" when the date is 28 days in the past', () => {
    const todoDate = 100;
  ...
  it('should return "1 year ago" when the date is 1 year in the past', () => {
    const todoDate = 100;
