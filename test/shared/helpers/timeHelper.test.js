...
describe('formatTime', () => {
  ...
  it('should return return "1 second ago" when the date passed in is the same as the current time', () => {
    const blogDate = 100;
  ...
  it('should return return "5 seconds ago" when the date is 5 seconds in the past', () => {
    const blogDate = 100;
  ...
  it('should return return "1 minute ago" when the date is 1 minute in the past', () => {
    const blogDate = 100;
  ...
  it('should return return "10 minutes ago" when the date is 10 minutes in the past', () => {
    const blogDate = 100;
  ...
  it('should return return "1 hour ago" when the date is 1 hour in the past', () => {
    const blogDate = 100;
  ...
  it('should return return "3 hours ago" when the date is 3 hours in the past', () => {
    const blogDate = 100;
  ...
  it('should return return "1 day ago" when the date is 1 day in the past', () => {
    const blogDate = 100;
  ...
  it('should return return "6 days ago" when the date is 6 days in the past', () => {
    const blogDate = 100;
